          ...
          <div className="mx-auto max-w-5xl items-center justify-center">
            <div className="flex flex-col text-center px-4">
              ...
              <form className="flex flex-row justify-center items-center" onSubmit={onFormSubmit}>
                <input type="email" name="email" placeholder="Email" className={["w-2/5 outline-none bg-gray-3 hover:bg-gray-4 focus:bg-gray-4 text-sm px-4 h-10 rounded-2xl", styles.email].join(" ")} required="required" autocomplete="off"/>
