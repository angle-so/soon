          ...
          <div className="mx-auto max-w-5xl items-center justify-center">
            <div className="flex flex-col text-center px-4">
              ...
              <form className="flex flex-row justify-center items-center relative">
                ...
                <input type="email" name="email" placeholder="Email" className=" pl-11 w-4/6 text-lg outline-none bg-neutral-800  hover:bg-gray-4 focus:bg-gray-4 px-4 h-10 rounded-2xl placeholder:text-gray-500 text-white left-16" required autoComplete="off" disabled={loading || result?.success} value={(result?.success && result?.message) || emailRef.value}/>
